...
ann = Chain(
    ...
    # Salidas de esta capa: matriz 4D de dimension 7 x 7 x 32canales x <numPatrones>
    Conv((3, 3), numColors*64=>numColors*128, pad=(1,1), funcionTransferenciaCapasConvolucionales),
    ...
    # Entradas a esta capa: matriz 4D de dimension 7 x 7 x 32canales x <numPatrones>
    # Salidas de esta capa: matriz 4D de dimension 7 x 7 x 32canales x <numPatrones>
    Conv((3, 3), numColors*128=>numColors*128, pad=(1,1), funcionTransferenciaCapasConvolucionales),
