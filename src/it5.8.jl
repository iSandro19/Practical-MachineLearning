...
ann = Chain(
    ...
    Conv((4, 4), numColors*32=>numColors*32, pad=(1,1), funcionTransferenciaCapasConvolucionales),
    ...
    # Entradas a esta capa: matriz 4D de dimension 7 x 7 x 32canales x <numPatrones>
    # Salidas de esta capa: matriz 4D de dimension 7 x 7 x 32canales x <numPatrones>
    Conv((4, 4), numColors*64=>numColors*64, pad=(1,1), funcionTransferenciaCapasConvolucionales),
