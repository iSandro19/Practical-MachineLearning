...
ann = Chain(
    ...
    Conv((3, 3), numColors=>16*numColors, pad=(1,1), funcionTransferenciaCapasConvolucionales),
    ...
    Conv((3, 3), numColors*16=>numColors*32, pad=(1,1), funcionTransferenciaCapasConvolucionales),
    ...
    # Entradas a esta capa: matriz 4D de dimension 7 x 7 x 32canales x <numPatrones>
    # Salidas de esta capa: matriz 4D de dimension 7 x 7 x 32canales x <numPatrones>
    Conv((3, 3), numColors*64=>numColors*64, pad=(1,1), funcionTransferenciaCapasConvolucionales),
