...
ann = Chain(
    ...
    Conv((5, 5), numColors=>16*numColors, pad=(1,1), funcionTransferenciaCapasConvolucionales),
    ...
    Conv((5, 5), numColors*16=>numColors*32, pad=(1,1), funcionTransferenciaCapasConvolucionales),
    ...
    # Salidas de esta capa: matriz 4D de dimension 7 x 7 x 32canales x <numPatrones>
    Conv((5, 5), numColors*32=>numColors*32, pad=(1,1), funcionTransferenciaCapasConvolucionales),
